...
- (CGFloat)frameBottomLineY {
    return self.frame.size.height;
}

- (void)setFrameBottomLineY:(CGFloat)newY{
    self.frame = CGRectMake(self.frame.origin.x, newY - 0.5f, self.frame.size.width, self.frame.size.height);
}
